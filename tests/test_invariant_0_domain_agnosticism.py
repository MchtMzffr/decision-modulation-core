...
Public surface: README.md, docs/** (excluding docs/examples), dmc_core/**.
No domain-specific lexemes (trade, bid, ask, spread, pnl, etc.) in public surface.
"""
...
EXCLUDE_PATTERNS = [
    ...
    r"docs[/\\]SAFETY_LIMITATIONS\.md",
    r"dmc_core[/\\]security[/\\]",  # legacy gating; deprecated alias names
    r"tests/.*",
]
...
def _check_file(file_path: Path, repo_root: Path) -> list[tuple[int, str, str]]:
    violations = []
    try:
